...
st.altair_chart(
    new_admissions_chart(alt, projection_admits, p.n_days - 10, p.max_y_axis), use_container_width=True,
)
...
st.altair_chart(admitted_patients_chart(alt, census_df, p.n_days - 10, p.max_y_axis), use_container_width=True)
...
if st.checkbox("Show Additional Projections"):
    show_additional_projections(st, alt, additional_projections_chart, p.infected_v, p.recovered_v, p.max_y_axis)
