...
st.markdown("Running **census** of COVID-19 patients, accounting for arrivals and discharges at Penn hospitals")
...
st.markdown("""**Click the checkbox below to view additional data generated by this simulation**""")
