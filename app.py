...
st.altair_chart(
    new_admissions_chart(alt, projection_admits, n_days - 10, as_date=as_date), use_container_width=True
)
...
st.altair_chart(admitted_patients_chart(alt, census_df, n_days - 10), use_container_width=True)
