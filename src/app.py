...
st.markdown("Projected number of **daily** COVID-19 admissions at hospitals")
...
st.markdown("Projected **census** of COVID-19 patients, accounting for arrivals and discharges at hospitals")
