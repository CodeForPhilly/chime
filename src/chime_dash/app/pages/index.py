...
class Index(Component):
    ...
    @staticmethod
    def build_graphs_and_tables(model, pars, content):
        admissions_data = {}
        admissions_table_data = None
        census_data = {}
        census_table_data = None
        evo_figure = {"layout": {"height ": 0}}
        evo_table = None
        admissions_csv = None
        census_csv = None
        ...
        if model and pars:
            ...
            if content:
                ...
                evo_figure["layout"]["height"] = False
    ...
    def toggle_additions(switch_value):
        return toggle_hidden(switch_value, 1)
    ...
    def toggle_tables(switch_value):
        return toggle_hidden(switch_value, 3)
    ...
    def __init__(self, language, defaults):
        ...
        def handle_model_change_helper(pars_json):
            ...
            graphs_and_tables_and_csvs_oh_my = Index.build_graphs_and_tables(model, pars, self.content)
            return intro + more_intro + graphs_and_tables_and_csvs_oh_my
